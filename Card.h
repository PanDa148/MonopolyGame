...
class Card{
	...
	virtual void function(Player& player, std::vector<Space*>& spaces_ref, std::vector<Player>& players_ref);
};
...
class Collect : public Card{
	...
	void function(Player& player, std::vector<Space*>& spaces_ref, std::vector<Player>& players_ref);
};
